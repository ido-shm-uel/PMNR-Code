    ...
    */
    ...
    /*
      Bound propagation methods:
        ...
        - getInfeasibleBranches: this is the function that an
...
private:
    ...
    Vector<Vector<PolygonalTightening>> generatePolygonalTighteningsForPMNR();

    // Select neurons for PMNR: Randomly, Heuristically, From all layers.
    Vector<Vector<NeuronIndex>> selectPMNRNeurons();
    Vector<Vector<NeuronIndex>> selectPMNRNeuronsRandomly();
    Vector<Vector<NeuronIndex>> selectPMNRNeuronsHeuristically();
    Vector<Vector<NeuronIndex>> selectPMNRNeuronsFromAllLayers();
    ...
    */
    ...
    double calculatePMNRNSSEScore( NeuronIndex index );
    ...
    // Get all indices of layers with non-fixed neurons.
