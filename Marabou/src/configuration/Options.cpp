...
MILPSolverBoundTighteningType Options::getMILPSolverBoundTighteningType() const
{
    if ( gurobiEnabled() )
    {
        ...
        if ( strategyString == "backward-pmnr-all" )
            return MILPSolverBoundTighteningType::BACKWARD_ANALYSIS_PMNR_ALL;
        if ( strategyString == "backward-pmnr-random" )
            return MILPSolverBoundTighteningType::BACKWARD_ANALYSIS_PMNR_RANDOM;
        if ( strategyString == "backward-pmnr-once" )
            return MILPSolverBoundTighteningType::BACKWARD_ANALYSIS_PMNR_ONCE;
