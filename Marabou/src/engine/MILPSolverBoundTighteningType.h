...
enum class MILPSolverBoundTighteningType {
    ...
    // Perform backward analysis using PMNR, PMNR-ALL, PMNR (random) or PMNR (n=1).
    BACKWARD_ANALYSIS_PMNR = 8,
    BACKWARD_ANALYSIS_PMNR_ALL = 9,
    BACKWARD_ANALYSIS_PMNR_RANDOM = 10,
    BACKWARD_ANALYSIS_PMNR_ONCE = 11,
